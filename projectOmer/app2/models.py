...
class TbCountry(models.Model):
    ...
    idstatus = models.ForeignKey(TbStatus, on_delete=models.CASCADE)  # Field name made lowercase.
...
class TbCity(models.Model):
    ...
    description = models.TextField(blank=True, null=True)
    idstatus = models.ForeignKey(TbStatus,on_delete=models.CASCADE)   # Field name made lowercase.
    idcountry = models.ForeignKey(TbCountry, on_delete=models.CASCADE)  # Field name made lowercase.
...
class TbStore(models.Model):
    ...
    idcity = models.ForeignKey(TbCity, on_delete=models.CASCADE)   # Field name made lowercase.
    idstatus = models.ForeignKey(TbStatus,on_delete=models.CASCADE)  # Field name made lowercase.
...
class TbUserStore(models.Model):
    ...
    iduser = models.ForeignKey(TbUser, on_delete=models.CASCADE) # Field name made lowercase.
    idstore = models.ForeignKey(TbStore,on_delete=models.CASCADE)  # Field name made lowercase.
    idstatus = models.ForeignKey(TbStatus, on_delete=models.CASCADE)  # Field name made lowercase.
